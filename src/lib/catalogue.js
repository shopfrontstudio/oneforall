import { PHASE1_SERVICES, PHASE1_SERVICE_MAP } from '../domain/catalogue.js';
...
export function servicePathwayLabel(service) {
  if (service?.key === 'general.guided_request') return 'Guided service triage';
  return PATHWAY_LABELS[service?.pathway] || 'Managed service pathway';
}
