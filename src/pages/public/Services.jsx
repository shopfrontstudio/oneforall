...
export default function Services() {
  ...
  return (
    <div className="space-y-9">
      <header className="max-w-3xl"><p className="text-xs font-bold uppercase tracking-[0.16em] text-terracotta">Local service catalogue</p><h1 className="mt-2 text-3xl font-semibold sm:text-4xl">Choose the pathway that fits the work.</h1><p className="mt-3 text-muted-foreground">Every category is open for requests, with explicit allowed, reviewed and blocked boundaries. Provider availability, price and timing are confirmed before booking.</p></header>
