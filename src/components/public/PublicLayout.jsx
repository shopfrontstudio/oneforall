...
export default function PublicLayout() {
  return (
    <div className="min-h-screen overflow-x-clip">
      <BrandBackground />
      <header className="public-site-header sticky top-0 z-50">
        <div className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-3 px-4 py-3">
          ...
          <nav aria-label="Primary" className="order-3 grid w-full grid-cols-5 gap-1 rounded-2xl bg-white/90 p-1 shadow-sm backdrop-blur-xl md:order-2 md:w-auto xl:bg-transparent xl:p-0 xl:shadow-none xl:backdrop-blur-none">
