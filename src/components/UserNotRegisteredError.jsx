    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen p-5">
      ...
      <div className="glass max-w-md w-full p-8 rounded-3xl">
        <div className="text-center">
          ...
          <div className="inline-flex items-center justify-center w-16 h-16 mb-6 rounded-2xl bg-terracotta/15">
          ...
          <div className="p-4 bg-mist-soft rounded-2xl text-sm text-muted-foreground border border-border/70">
