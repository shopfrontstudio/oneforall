...
export const PHASE1_SERVICES = Object.freeze([
  ...
  service({
    key: 'building-renovation.managed_quote', category: 'building-renovation', name: 'Building and renovation', pathway: 'managed_quote', manual_review_required: true,
    scope_options: [
      option('renovation-consultation', 'Renovation consultation and scope', ['renovation consultation', 'renovation scope']),
      option('non-structural-renovation', 'Non-structural renovation work', ['non-structural renovation', 'room renovation']),
      option('building-repairs', 'Building repair assessment', ['building repair', 'repair assessment']),
    ],
    review_scope: ['Every request', 'Registration, permit, engineering and trade dependencies'],
    blocked_scope: ['Unlicensed or unpermitted regulated building work', 'Work without required engineering', 'Asbestos disturbance', 'Immediate structural danger'],
    ...
    block_terms: ['unlicensed building', 'without permit', 'without engineering', 'asbestos disturbance', 'immediate structural danger'],
